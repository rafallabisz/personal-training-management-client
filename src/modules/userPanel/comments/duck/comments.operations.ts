...
import { addCommentRequest, addCommentSuccess, addCommentFailure, getTrainerCommentsRequest, getTrainerCommentsSuccess, getTrainerCommentsFailure } from "./comments.actions";
...
export const getTrainerCommentsActionCreator: ActionCreator<
ThunkAction<Promise<Action>, CommentsResponse, string, AnyAction>
